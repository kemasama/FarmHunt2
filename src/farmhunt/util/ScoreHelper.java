...
public class ScoreHelper {
    ...
    private Objective sidebar/** @reg **/, playerList, belowName/** @reg **/;
	...
	private ScoreHelper(Player player) {
        ...
        belowName.setDisplayName("§cHealth");
	...
	public void setHealth(Player player, int amount) {
		...
		double ptg = (player.getHealth() / player.getMaxHealth()) * 100;
		belowName.getScore(player).setScore((int) ptg);
	}
	/** @reg **/
